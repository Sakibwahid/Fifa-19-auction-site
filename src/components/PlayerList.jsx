...
const PlayerList = () => {
    ...
    return (
        <div className="z-10 min-h-screen flex flex-col justify-center items-center">
                    ...
                    <tbody>
                        {data.map((player, index) => (
                            <tr key={index} className="border-b">
                                <td className="flex items-center gap-2 py-2 px-4 border">
                                    <input
                                        type="checkbox"
                                        value={player.Name}
                                ...
                                <td className="py-2 px-4 border">{player.Overall}</td>
                                <td className="py-2 px-4 border">{player.Value}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
            ...
            <div className="my-4">
                    <Button onClick={()=> console.log("Button clikced")}>
